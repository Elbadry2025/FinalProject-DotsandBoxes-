...
int main()
{
    ...
    while(moves<totalmoves){
        ...
        int tempScore1 = Scorefun(size1,arr1);
                        for(int i=0 ;i<size1; i++){
                    for(int j=0 ; j<size1 ; j++){
                        playes.arr[i][j] = arr1[i][j] ;
                }
        ...
        playes.scoreplayer1 = score1;
        playes.scoreplayer2 = score2;
        U[playes.move]=playes ;
        if(tempScore1){
            goto there;
        }
        printf("%d",U[moves].WhichPlayer) ;
        ...
        playes.move = moves ;
        playes.WhichPlayer = v ;
        int tempScore2 = Scorefun(size1, arr1);
          for(int i=0 ;i<size1; i++){
                    for(int j=0 ; j<size1 ; j++){
                        playes.arr[i][j] = arr1[i][j] ;
                }
